    ...
    <tr style="width: 100%">
        <td class="content-cell" style="padding: 20px 32px 10px 32px !important; width: 60%; border-top: 3px solid darkgreen">
            <span style="font-weight: bold; color: black;">
                Order Cancelled #{{ $data->invno }}
            </span>
            <br><br>
            The Mail is to inform you that order <span style="color: green"> #{{ $data->invno }} </span> belonging to <span style="color: green;">  {{ $data->customer->name }} </span> has been <span style="font-weight: bold"> cancelled.</span> <br>
        </td>
    </tr>
</table>
