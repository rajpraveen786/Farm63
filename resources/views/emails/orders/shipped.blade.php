...
<div style="font-size: 0.8em; padding: 0px 32px 32px 32px">
    Click <a href="https://farm63.com/profile/orders" style="margin: auto 0.35rem;color: green; font-weight: bold; font-size: 1.2em; text-decoration: underline rgba(0, 255, 0, 0.5)">HERE</a> to view complete order details. <br><br>
