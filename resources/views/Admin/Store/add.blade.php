...
<div class="container mt-3">
    ...
    <div class="card shadow-custom" style="border-radius: 8px">
        <div class="card-body">
            <h3 class="mb-3 color-prim">Store - Add</h3>
            <form action="/admin/store/add" method="POST" class="forms-" enctype="multipart/form-data"> @csrf
                <div class="form-row my-2">
                    ...
                    <div class="form-group mt-2 col-md-6">
                        <input type="text" class="input-hov form-control {{ $errors->has('location')? 'is-invalid ':'' }}" autocomplete="off" name="location" id="inputName4" placeholder="Enter Location" value="{{ old('location')??'' }}">
