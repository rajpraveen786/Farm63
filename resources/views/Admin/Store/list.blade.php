...
<div class="container mt-3">
    <nav aria-label="breadcrumb">
        <div class="float-right">
            <a href="/admin/store/add" class="btn btn-outline-custom"> <i class="fa fa-plus" aria-hidden="true"></i>
                Add</a>
        </div>
            ...
            <div class="card shadow-custom px-3" style="border-radius: 8px">
                ...
                <form action="" class="forms-">
                    ...
                    <div class="d-flex mb-2 justify-content-end">
                        <a href="/admin/store" class='btn btn-outline-dark mx-1'>
                            ...
                            @for($i=0;$i<$data->count();$i++)
                                <tr>
                                    ...
                                    <td class="text-center d-flex flex-row justify-content-around">
                                        <a href="/admin/store/view/{{ encrypt($data[$i]->id) }}" class="btn">
                                        ...
                                        <div class="dropdown-menu" style="border-radius: 5px">
                                            <ul class="m-0 p-0" style="list-style: none;">
                                                <li class="m-0 p-0" style="color: rgba(0, 0, 0, 0.7)"><a href="/admin/store/edit/{{ encrypt($data[$i]->id) }}" class="drop-hov"> <i class="fa fa-edit ml-3"></i><span class="ml-3"> Edit</span></a></li>
                                                <li class="m-0 p-0" style="color: rgba(0, 0, 0, 0.7)"><a href="/admin/store/delete/{{ encrypt($data[$i]->id) }}" onclick="return confirm('Are you sure you want to delete ?');" class="drop-hov"><i class="fa fa-trash ml-3"></i><span class="ml-3"> Delete</span></a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
