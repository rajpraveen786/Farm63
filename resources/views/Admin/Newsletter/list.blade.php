...
<div class="container mt-3">
    <nav aria-label="breadcrumb">
        <div class="float-right">
            <a href="/admin/newsletter/add" class="btn btn-outline-custom"> <i class="fa fa-plus" aria-hidden="true"></i>
                Add</a>
        </div>
            ...
            <div class="card shadow-custom px-3" style="border-radius: 8px">
                ...
                <form action="" class="forms-">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            <select name="sent" class="input-hov form-control" id="exampleFormControlSelect1">
                                <option @if(request()->get('sent')>-1) selected @endif value="-1">Select To filter</option>
                                <option @if(request()->get('sent')==0) selected @endif value="0">Draft</option>
                                <option @if(request()->get('sent')==1) selected @endif value="1">Active</option>
                            </select>
                            <label for="exampleFormControlSelect1">Sent</label>
                        </div>
                    </div>
                    <div class="d-flex mb-2 justify-content-end">
                        <a href="/admin/newsletter" class='btn btn-outline-dark mx-1'>
                        ...
                        <tbody>
                            @for($i=0;$i<$data->count();$i++)
                                <tr>
                                    ...
                                    <td>
                                        @if($data[$i]->sent) <span class="badge badge-pill badge-success">Sent</span>
                                        @else <span class="badge badge-pill badge-danger">Draft</span>
                                        @endif
                                    </td>
                                    <td class="text-center d-flex flex-row justify-content-around">
                                        ...
                                        <div class="dropdown-menu" style="border-radius: 5px">
                                            <ul class="m-0 p-0" style="list-style: none;">
                                                <li class="m-0 p-0" style="color: rgba(0, 0, 0, 0.7)"><a href="/admin/newsletter/edit/{{ encrypt($data[$i]->id) }}" class="drop-hov"> <i class="fa fa-edit ml-3"></i><span class="ml-3"> Edit</span></a></li>
                                                <li class="m-0 p-0" style="color: rgba(0, 0, 0, 0.7)"><a href="/admin/newsletter/delete/{{ encrypt($data[$i]->id) }}" onclick="return confirm('Are you sure you want to delete ?');" class="drop-hov"><i class="fa fa-trash ml-3"></i><span class="ml-3"> Delete</span></a></li>
                                            </ul>
                                        </div>
                                        @endif
                                    </td>
