                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control" id="type">
                                <option @if(old('type') && old('type')==0 || $data->type==0) selected @else selected @endif value="0">Product</option>
                                <option @if(old('type') && old('type')==1 || $data->type==1) selected @endif value="1">Combo</option>
                            </select>
                        </div>
                        <hr>
