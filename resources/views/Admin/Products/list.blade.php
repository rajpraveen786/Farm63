...
<div class="container mt-3">
    <nav aria-label="breadcrumb">
        <div class="float-right">
            <a href="/admin/products/add" class="btn btn-outline-custom"> <i class="fa fa-plus" aria-hidden="true"></i>
                Add</a>
        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            <select name="status" class="input-hov form-control" id="exampleFormControlSelect1">
                                ...
                                <option {{ $status==-1 ?'selected':'' }} value="-1">Select To filter</option>
                            </select>
                            <label for="exampleFormControlSelect1">Status</label>
                        </div>
                    </div>
                    <div class="d-flex mb-2 justify-content-end">
                        <a href="/admin/products" class='btn btn-outline-dark mx-1'>
                        ...
                        <tbody>
                            @for($i=0;$i<$data->count();$i++)
                                <tr>
                                    ...
                                    <td><img loading="lazy" src="/{{ $data[$i]->image->loc ??''}}" class="w-100" alt=""> </td>
                                    <td>{{ $data[$i]->name }}</td>
                                    <td>
                                    ...
                                    <td>{{ $data[$i]->fpricewtas }}</td>
                                    <td class="text-center d-flex flex-row justify-content-around">
                                        <a href="/admin/products/view/{{ encrypt($data[$i]->id) }}" class="btn">
                                        ...
                                        <div class="dropdown-menu" style="border-radius: 5px">
                                            <ul class="m-0 p-0" style="list-style: none;">
                                                <li class="m-0 p-0" style="color: rgba(0, 0, 0, 0.7)"><a href="/admin/products/edit/{{ encrypt($data[$i]->id) }}" class="drop-hov"> <i class="fa fa-edit ml-3"></i><span class="ml-3"> Edit</span></a></li>
                                                <li class="m-0 p-0" style="color: rgba(0, 0, 0, 0.7)"><a href="/admin/products/delete/{{ encrypt($data[$i]->id) }}" onclick="return confirm('Are you sure you want to delete ?');" class="drop-hov"><i class="fa fa-trash ml-3"></i><span class="ml-3"> Delete</span></a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
