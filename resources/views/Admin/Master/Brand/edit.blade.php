...
<div class="container mt-3">
    <nav aria-label="breadcrumb">
        <div class="float-right">
            <a href="/admin/master/brand/view/{{ encrypt($data->id) }}" class="btn btn-outline-custom py-1"><i class="fa fa-eye fa-fw"></i> View</a>
    ...
    <div class="card shadow-custom" style="border-radius: 8px">
        <div class="card-body">
            <h3 class="mb-3 color-prim">Brand - Edit</h3>
            <form action="/admin/master/brand/edit/{{ encrypt($data->id) }}" method="POST" class="forms-" enctype="multipart/form-data"> @csrf
