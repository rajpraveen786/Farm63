    ...
    <div class="row">
            ...
            <div class="card shadow-custom px-3" style="border-radius: 8px">
                ...
                <form action="" class="forms-">
                    ...
                    <div class="d-flex mb-2 justify-content-end">
                        ...
                        <a href="/admin/reports/stock" class='btn btn-outline-dark mx-1'>
                            <i class="fa fa-search-minus" aria-hidden="true"></i> Clear</a>
                        <a href="/admin/reports/stock?export=1&status={{ request()->get('status') }}" class='btn btn-outline-dark mx-1'>
        ...
        <div class="col-12 mt-3">
            <div class="card shadow-custom pt-3" id='tableprint' style="border-radius: 8px">
                <div class="card-body">
                    <h4 class="color-prim font-weight-bold pb-2">Stock Report</h4>
                    @if($data->count()>0)
