    ...
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <div class="card shadow-custom pt-3" id='tableprint' style="border-radius: 8px">
                <div class="card-body">
                    <h4 class="color-prim font-weight-bold pb-2">Sales Report</h4>
                    @if($data->count()>0)
                    <table class="table table-list table-responsive">
                        <thead>
                        ...
                        <tbody>
                            @for($i=0;$i<$data->count();$i++)
                                <tr>
                                    ...
                                    <td>
                                        <a style="text-decoration:none" href="/admin/store/view/{{ $data[$i]->store->id }}">
                                            {{ $data[$i]->store->name }}
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td class='text-right'>{{ $data[$i]->created_at }}</td>
                                    <td class='text-right'>{{ $data[$i]->completed_at }}</td>
                                </tr>
                                @endfor
                        </tbody>
                    </table>
