...
<div class="container mt-3">
    ...
    <h3 class="mb-3 color-prim">Net Discounts - Edit</h3>
    <form action="/admin/discounts/netdiscount/edit/{{ encrypt($data->id) }}" method="POST" class="forms-" enctype="multipart/form-data"> @csrf
        <div class="row">
