...
<div class="container mt-3">
    <nav aria-label="breadcrumb">
        ...
        <ol class="breadcrumb" style="background-color: transparent">
            ...
            <li class="breadcrumb-item"><a href="/admin/pages">Banner</a></li>
    ...
    <div class="card shadow-custom" style="border-radius: 8px">
        <div class="card-body">
            ...
            <form action="/admin/pages/{{ $pagename }}/subbanner/edit/{{ $data->id }}" method="POST" class="forms-" enctype="multipart/form-data"> @csrf
                <div class="form-row my-2">
                    ...
                    <div class="mt-2 col-12">
                        ...
                        :oldlinkt='{{ json_encode(old('linkt')??$data->linkt??'') }}'
                        :oldoptsel='{{ json_encode(old('optsel')??$data->optsel??'') }}'
