        ...
        <div class="row position-relative">
          ...
          <div class="col-lg-9 col-sm-12 py-3">
            <div
              ...
              v-if="brand.banner"
              class="row h-catrow"
              :style="'background-image: url(/'+brand.banner+');background-size: cover;background-position: center; background-color: white'"
            ></div>
            ...
            <li class="breadcrumb-item d-inline"><a class='text-dark' style="pointer-events: none" href=""> Category</a></li>
...
<hr />
    ...
    <div id="searchlistdata" v-else>
            <div v-if="datas.length >0" class="row bg-bluee py-2">
              <div
                class="col-md-3 px-2 col-6 my-2"
...
export default {
  ...
  methods: {
    ...
    searchapi() {
      var self = this;
      axios
        .post("/branddata?page=" + this.page, {
            mainid:this.brand.id,
