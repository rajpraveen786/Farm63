        ...
        <div class="row">
          ...
          <div class="col-lg-9 col-sm-12">
            <!-- <div
              class="row"
              style="
                background-image: url('/storage/tryimg/vakilimg/car2.jpg');
            ...
            <div class="float-right">
              <select
                v-model="orderbyid"
                @change="changeordby"
                class="btn form-select font-weight-bold select-custom-ms my-3 form-select-sm"
            ...
            <h4 class="font-prim color-prim2 mt-4 font-weight-bold">Hot Deals</h4>
            <hr />
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-6 col-10">
                        <div class="card mt-3 shadow p-4">
                            ...
                            <div style="font-size: 0.65em" class="font-prim mt-3 font-weight-bold">
  ...
  methods: {
    ...
    searchapi() {
      var self = this;
          self.loading = 1;
      axios
        .post("/hotdealsdata?page=" + this.page, {
