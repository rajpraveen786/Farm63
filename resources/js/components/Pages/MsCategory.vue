      ...
      <div class="row position-relative">
        <div class="col-lg-3 col-sm-12 menu-inlg py-2">
          <div class="expand-menu">
            <button
              class="btn btn-success d-lg-none font-prim font-weight-bold"
              type="button"
            ...
            <div class="collapse menu-collapse" id="navbarTogglerDemo03">
              <div class="mt-2 p-3 card">
                <div v-if="category.subcategory.length > 0">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div
                        class="check-custom form-check"
                        v-for="(itemsub, index2) in item.subcategory"
                        :key="'subcategorylist' + index"
                      >
                        <label class="form-check-label">
                          <input
                            class="form-check-input"
                ...
                <!-- <div>
                    ...
                    <div v-else class="mt-1">Sorry No Brand found</div>
                  </div> -->
                <div>
                  <div class="float-right h6">
                    <button
                      type="button"
                      class="btn text-small text-muted"
        ...
        <div class="col-lg-9 col-sm-12 py-3">
          ...
          <div class="float-md-right" style="margin-top: -0.7rem">
            <select
              v-model="orderbyid"
              @change="changeordby"
              class="btn form-select font-weight-bold btn-success my-3 form-select-sm"
          ...
          <ol
            class="breadcrumb breadcrumb-bar"
          ...
          >
            ...
            <li class="breadcrumb-item d-inline">
              <a class="text-dark" style="pointer-events: none" href="">Category </a>
            </li>
            <li
          ...
          <div id="searchlistdata" v-else>
            <div v-if="datas.length > 0" class="row no-gutters bg-bluee py-2">
              <div
                class="col-md-3 col-6 my-2"
                v-for="(itemx, index) in datas"
                :key="index + 'savelaterlist'"
              >
                ...
                <div class="col-md-6 col-10">
                  <div class="card mt-3 shadow p-4">
                    <img
                      ...
                      alt=""
                      class="w-nodata w-75 mx-auto"
                    />
                    <div
                      style="font-size: 0.75em"
                      class="font-prim mt-3 font-weight-bold"
                    >
                      We couldn't find your product, Click
                      <a href="/" class="btn-link">Here</a> to continue shopping from our
                      other products
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    searchapi() {
      ...
      self.loading = 1;
      axios
        .post("/categorydata?page=" + this.page, {
          mainid: this.category.id,
