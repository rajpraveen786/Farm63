        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">
              <span v-if="type == 0">New Attribute</span>
              <span v-else-if="type == 1">Edit Attribute</span>
            </h5>
            <button
              type="button"
              class="close"
          ...
          <div class="modal-body">
            <div class="form-row my-2">
              <div class="form-group mt-2 col-md-6">
                <label for="inputAttribute4">Attribute</label>
                <input
                  type="text"
  ...
  methods: {
    ...
    newdata() {
      ...
      if (this.seldata != "" && this.seldata.length > 0) {
        axios
          .post("/admin/master/attribute/add", {
            name: this.seldata,
          })
          .then((res) => {
            ...
            Vue.swal({
              title: "Sucess.",
              text: "Attribute added successfull.",
              icon: "success",
            });
          })
          .catch((err) => {
        ...
        alert("Please enter new Attribute");
      }
    },
    editmodal(index) {
      this.type = 1;
    ...
    editdata() {
      ...
      if (this.seldata != "" && this.seldata.length > 0) {
        axios
          .post("/admin/master/attribute/edit", {
            name: this.seldata,
            id: this.selid,
          })
          .then((res) => {
            ...
            Vue.swal({
              title: "Sucess.",
              text: "Attribute edited successfull.",
              icon: "success",
            });
          })
          .catch((err) => {
    ...
    deletedata(item, index) {
      ...
      if (confirm("Are you sure do you want to delete?")) {
        axios
          .post("/admin/master/attribute/delete", {
            id: item.id,
          })
          .then((res) => {
            ...
            Vue.swal({
              title: "Sucess.",
              text: "Attribute deleted successfull.",
              icon: "success",
            });
          })
          .catch((err) => {
