        ...
        <div class="card shadow-custom px-3" style="border-radius: 8px">
          ...
          <form action="" class="forms-">
            ...
            <div class="d-flex mb-2 justify-content-end">
              <a href="/admin/master/tags" class="btn btn-outline-dark mx-1">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">
              <span v-if="type == 0">New Tags</span>
              <span v-else-if="type == 1">Edit Tags</span>
            </h5>
            <button
              type="button"
              class="close"
          ...
          <div class="modal-body">
            <div class="form-row my-2">
              <div class="form-group mt-2 col-md-6">
                <label for="inputTags4">Tags</label>
                <input
                  type="text"
