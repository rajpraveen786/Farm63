  ...
  <div>
    ...
    <div class="card shadow-custom mt-2" style="border-radius: 8px">
      <div class="card-body">
        ...
        <!-- <div class="form-group mt-2 form-check text-muted">
            <input
              type="checkbox"
              ...
              id="onlydiscount"
            />
            <h5 class="form-check-label mx-2" for="onlydiscount"
              >Only apply discount once per order <br />
              If unchecked, this discount will apply to each eligible product in
              an order.</h5
            >
          <small v-if="errors.oosc" class="form-text text-danger">{{
            errors.oosc
          }}</small>
          </div> -->
      </div>
